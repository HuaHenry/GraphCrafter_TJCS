  ...
  export default {
    data() {
      return {
        menuContent: [
          {
            src: require("../assets/img/menu/oceantown.jpg"),
            title: "图像处理",
            href: "/main-demo",
          },
          {
            src: require("../assets/img/menu/flower.jpg"),
            title: "分享广场",
            href: "/main-demo",
          },
          {
            src: require("../assets/img/menu/person.jpg"),
            title: "个人中心",
            href: "/main-demo",
          },
        ],
        demoContent: [
          {
            src: require("../assets/img/demos/demo1.jpg"),
            title: "假日海边风景拍照配方",
            href: "/minimal-agency",
          },
          {
            src: require("../assets/img/demos/demo2.jpg"),
            title: "旋转的春日",
            href: "/freelancer",
          },
          {
            src: require("../assets/img/demos/demo3.jpg"),
            title: "绿野仙踪调色",
            href: "/creative-portfolio",
          },
          {
            src: require("../assets/img/demos/demo4.jpg"),
            title: "假期去旅行",
            href: "/agency",
          },
          {
            src: require("../assets/img/demos/demo5.jpg"),
            title: "治愈通透配方",
            href: "/multiscroll-portfolio",
          },
          {
            src: require("../assets/img/demos/demo6.jpg"),
            title: "草原山脉配方",
